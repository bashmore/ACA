...
/**
 * controller is a JavaScript object created by a standard JavaScript object
 * constructor. creates the controller name 'customerCtrl' and passes in the
 * $scope object. you can add properties to the $scope object, the view can
 * access them.
 */
custApp.controller('customerCtrl', function($scope, $http) {	
	
	$scope.companyName = 'company name: Ashmore Consulting';	
